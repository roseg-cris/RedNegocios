...
$stmt = $pdo->prepare(
    "SELECT f.id AS favorito_id, p.nombre AS producto_nombre, p.precio, p.precio_oferta,
...
<head>
	...
	<title>RedNegocios | Mis Favoritos</title>
                     ...
                     <div class="ps-page__content row">
                        ...
                        <div class="container">
                            ...
                            <div class="ps-section__header">
                                ...
                                <h4><?= count($misFavoritos) ?> producto(s) guardado(s)</h4>

                            </div>

                            <?php if (empty($misFavoritos)): ?>
                            <p class="text-muted"><em>Aún no has agregado productos a tus favoritos.</em></p>
                            <?php else: ?>
                            <div class="table-responsive mt-4">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?= htmlspecialchars($fav['producto_nombre']) ?></td>
                                            <td><?= htmlspecialchars($fav['negocio_nombre']) ?></td>
                                            <td>
                                                <?php if (!empty($fav['precio_oferta'])): ?>
                                                <span class="text-muted"><del>$<?= number_format((float) $fav['precio'], 2) ?></del></span>
                                                $<?= number_format((float) $fav['precio_oferta'], 2) ?>
                                                <?php else: ?>
                                                $<?= number_format((float) $fav['precio'], 2) ?>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if ($fav['disponibilidad'] === 'disponible'): ?>
