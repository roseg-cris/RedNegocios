            ...
            <div class="ps-section__header">
                ...
                <div class="ps-section__content">
                    ...
                    <ul class="ps-section__links">
                        ...
                        <li class="active"><a href="../../panel/perfil/editar_perfil_negocio.php">Editar perfil</a></li>
                    ...
                    ======================================--> 
                     <div class="ps-page__content row">
                        ...
                        <div class="container">
                            ...
                            <form class="ps-form--account" action="../../panel/perfil/perfil_negocio_procesar.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="mb-2">
                                            <img src="<?= !empty($negocio['logo']) ? '../../uploads/negocios/' . htmlspecialchars($negocio['logo']) . '?v=' . strtotime($negocio['updated_at']) : '../../assets/img/vendor/store/user/5.jpg' ?>" alt="Logo actual" style="width:90px;height:90px;object-fit:cover;border-radius:50%;">
                                        </div>
                                        <input class="form-control-file" type="file" name="logo" accept="image/jpeg,image/png,image/webp">
                                        <small class="form-text text-muted">JPG, PNG o WEBP, máximo 5 MB. Déjalo vacío para conservar el actual.</small>
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label>Foto de portada</label>
                                        <div class="mb-2">
                                            <img src="<?= !empty($negocio['portada']) ? '../../uploads/negocios/' . htmlspecialchars($negocio['portada']) . '?v=' . strtotime($negocio['updated_at']) : '../../assets/img/banner/top/header-promotion.jpg' ?>" alt="Portada actual" style="width:100%;max-width:220px;height:70px;object-fit:cover;border-radius:6px;">
                                        </div>
                                        <input class="form-control-file" type="file" name="portada" accept="image/jpeg,image/png,image/webp">
                                        <small class="form-text text-muted">JPG, PNG o WEBP, máximo 5 MB. Déjalo vacío para conservar la actual.</small>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="<?= htmlspecialchars($negocio['nombre']) ?>" disabled>
                                    <small class="form-text text-muted">El nombre del negocio no se puede modificar.</small>
                                </div>

                                <div class="form-row">

                                    <div class="form-group col-md-6">
                                        <label for="categoria_id">Categoría / Giro</label>
                                        <select class="form-control" id="categoria_id" name="categoria_id" required>
                                            <?php foreach ($categorias as $categoria): ?>
                                            <option value="<?= $categoria['id'] ?>" <?= $categoria['id'] == $negocio['categoria_id'] ? 'selected' : '' ?>><?= htmlspecialchars($categoria['nombre']) ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="form-control" type="text" id="direccion" name="direccion" value="<?= htmlspecialchars($negocio['direccion']) ?>" required>
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="form-control" type="text" id="telefono" name="telefono" value="<?= htmlspecialchars($negocio['telefono']) ?>" required>
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="whatsapp">WhatsApp</label>
                                        <input class="form-control" type="text" id="whatsapp" name="whatsapp" value="<?= htmlspecialchars($negocio['whatsapp'] ?? '') ?>">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="descripcion" name="descripcion" rows="4"><?= htmlspecialchars($negocio['descripcion'] ?? '') ?></textarea>
                                </div>

                                <div class="form-group submtit d-flex justify-content-end" style="gap: 12px;">
                                    <a href="../../panel/perfil/perfil_negocio.php" class="ps-btn ps-btn--black">Cancelar</a>
