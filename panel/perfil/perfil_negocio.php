            ...
            <div class="ps-section__header">
                ...
                <div class="ps-section__content">
                    ...
                    <ul class="ps-section__links">
                        <li class="active"><a href="../../panel/perfil/perfil_negocio.php">Mi perfil</a></li>
                    ...
                    ======================================--> 
                     <div class="ps-page__content row">
                        ...
                        <div class="container">
                            ...
                            <?php if ($mostrarPendiente): ?>
                            <div class="alert alert-warning">Tu negocio está pendiente de aprobación. Un administrador revisará tu información antes de publicarlo.</div>
                            <?php endif; ?>
                            ...
                            <div class="ps-section__header">
                                ...
                                <h4><?= htmlspecialchars($negocio['categoria_nombre']) ?></h4>

                            </div>

                            <?php if (!empty($negocio['descripcion'])): ?>
                            <p><?= nl2br(htmlspecialchars($negocio['descripcion'])) ?></p>
                            <?php else: ?>
                            <p class="text-muted"><em>Aún no has agregado una descripción de tu negocio.</em></p>
                            <?php endif; ?>
                                ...
                                <div class="col-lg-4 col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p><?= htmlspecialchars($negocio['telefono']) ?></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p><?= htmlspecialchars($negocio['email'] ?? '') ?></p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="mt-4">
                                <a href="../../panel/perfil/editar_perfil_negocio.php" class="btn btn-warning btn-lg">Editar perfil</a>
                            </div>
