        ...
        <div class="container">
            ...
            <div class="ps-form--account ps-tab-root">
                ...
                <ul class="ps-tab-list">
                    ...
                    <li class="<?= $tabActiva === 'sign-in' ? 'active' : '' ?>"><a href="login_negocio.php#sign-in">Iniciar sesión</a></li>

                    <li class="<?= $tabActiva === 'register' ? 'active' : '' ?>"><a href="registro_negocio.php#register">Registrarse</a></li>
                ...
                <div class="ps-tabs">
                    ...
                    <div class="ps-tab <?= $tabActiva === 'sign-in' ? 'active' : '' ?>" id="sign-in">
                        ...
                        <form action="login_negocio_procesar.php" method="POST">
                    ...
                    <div class="ps-tab <?= $tabActiva === 'register' ? 'active' : '' ?>" id="register">
                        ...
                        <form action="registro_negocio_procesar.php" method="POST">

                        <div class="ps-form__content">

                            <h5>Crea tu cuenta de proveedor</h5>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="nombre_negocio" placeholder="Nombre del negocio" required>
