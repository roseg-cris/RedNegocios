...
<head>
	...
	<title>RedNegocios | Iniciar sesión - Registro</title>
                    ...
                    <div class="header__actions">
                        ...
                        <div class="ps-block--user-header">
                            ...
                            <div class="ps-block__right">
                            	...
                            	<?php else: ?>
                            	<a href="login_usuario.php#sign-in">Iniciar sesión</a>
                            	<a href="registro_usuario.php#register">Registrarse</a>
                            	<?php endif; ?>
                            </div>
                        </div>
        ...
        <div class="container">
            ...
            <div class="ps-form--account ps-tab-root">
                ...
                <ul class="ps-tab-list">
                    ...
                    <li class="<?= $tabActiva === 'sign-in' ? 'active' : '' ?>"><a href="login_usuario.php#sign-in">Iniciar sesión</a></li>

                    <li class="<?= $tabActiva === 'register' ? 'active' : '' ?>"><a href="registro_usuario.php#register">Registrarse</a></li>
                ...
                <div class="ps-tabs">
                    ...
                    <div class="ps-tab <?= $tabActiva === 'sign-in' ? 'active' : '' ?>" id="sign-in">
                        ...
                        <form action="login_usuario_procesar.php" method="POST">
                    ...
                    <div class="ps-tab <?= $tabActiva === 'register' ? 'active' : '' ?>" id="register">
                        ...
                        <form action="registro_usuario_procesar.php" method="POST">

                        <div class="ps-form__content">

                            <h5>Crea tu cuenta de cliente</h5>
